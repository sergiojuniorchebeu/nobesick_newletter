  ...
  <div class="border-t border-gray-300 mt-12 pt-8">
    <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
      ...
      <div class="flex space-x-6 mt-4 md:mt-0">
        <a href="#" class="text-gray-600 hover:text-mustard transition-colors text-sm">Politique de confidentialité</a>
        <a href="#" class="text-gray-600 hover:text-mustard transition-colors text-sm">Conditions d'utilisation</a>
        <a href="#" class="text-gray-600 hover:text-mustard transition-colors text-sm">Mentions légales</a>
      </div>
    </div>
  </div>
</footer>